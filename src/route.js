...
*/
const Error = React.lazy(() => import('./Maintenance/Error'));
const OfflineUI = React.lazy(() => import('./Maintenance/OfflineUI'));
const ComingSoon = React.lazy(() => import('./Maintenance/ComingSoon'));
